...
const TrainingRoom: NextPage = () => {
  ...
  return (
    ...
    <HelmetComponent title={"Trading-Room"} />
    <Container
      fluid
      className=" justify-content-center align-items-center min-vh-100 mt-5"
    >
      <Row className="w-100 text-center">
        <Col md={6} className="mb-4">
          ...
          >
            <Card.Body>
              <Card.Title className="text-start">INVESTMENT CHECKLIST</Card.Title>
        ...
        <Col md={6} className="">
        <Card>
          <Card className="m-6 rounded-4" style={{ height: "250px", minWidth: "250px" }}>
          <Card.Body>
          ...
          <Card 
            className="m-6 p-4 d-flex flex-column justify-content-between rounded-4"
            style={{ height: "360px", minWidth: "250px" }}
          >
            <Card.Body>
              <Card.Title className="text-start">CHRONINVEST ASSISTANT</Card.Title>
              {[...Array(5)].map((_, index) => (
                <div
                  key={index}
