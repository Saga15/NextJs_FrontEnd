...
import { formatDate } from "../helper/customFunctions";
      ...
      >
        <Row className="w-100 text-center">
          ...
          <Col md={6} className="mb-4">
            ...
            >
              <Card.Body>
                <Card.Title className="text-start">COMPANY</Card.Title>
          ...
          <Col md={6} className="">
            ...
            >
              <Card.Body>
                <Card.Title className="text-start">CONFERENCE CALLS</Card.Title>
                {[...Array(5)].map((_, index) => (
          ...
          <Col md={6} className="">
            ...
            >
              <Card.Body>
                <Card.Title className="text-start">MACRO SYSTEMATIC</Card.Title>
                <hr className="border-primary my-6" />
                <hr className="border-primary my-6" />
                <hr className="border-primary my-6" />
                <hr className="border-primary my-6" />
          ...
          <Col md={6} className="">
            ...
            >
              <Card.Body>
                <Card.Title className="text-start">BULL/BEAR DEBATE</Card.Title>
                {[...Array(5)].map((_, index) => (
                  <div key={index} className="d-flex justify-content-between my-3">
                    <hr className="border-primary flex-grow-1 mx-2" />
                    <hr className="border-primary flex-grow-1 mx-2" />
